...
set(MSG_I_FLAGS "-Itrack_race:/home/foscar/ISCC_2022/src/lidar_team/track_race/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/foscar/ISCC_2022/src/lidar_team/track_race/msg/Velocity.msg" NAME_WE)
add_custom_target(_track_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "track_race" "/home/foscar/ISCC_2022/src/lidar_team/track_race/msg/Velocity.msg" ""
)

get_filename_component(_filename "/home/foscar/ISCC_2022/src/lidar_team/track_race/msg/Steering.msg" NAME_WE)
add_custom_target(_track_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "track_race" "/home/foscar/ISCC_2022/src/lidar_team/track_race/msg/Steering.msg" ""
)

get_filename_component(_filename "/home/foscar/ISCC_2022/src/lidar_team/track_race/msg/Test.msg" NAME_WE)
add_custom_target(_track_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "track_race" "/home/foscar/ISCC_2022/src/lidar_team/track_race/msg/Test.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/track_race)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/track_race\")")
  # install generated code
  install(
