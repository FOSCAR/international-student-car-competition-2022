...
set(MSG_I_FLAGS "-Iwaypoint_maker:/home/foscar/ISCC_2022/src/lidar_team/waypoint_maker/msg;-Isensor_msgs:/opt/ros/melodic/share/sensor_msgs/cmake/../msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg;-Inav_msgs:/opt/ros/melodic/share/nav_msgs/cmake/../msg;-Iactionlib_msgs:/opt/ros/melodic/share/actionlib_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/foscar/ISCC_2022/src/lidar_team/waypoint_maker/msg/DynamicVelocity.msg" NAME_WE)
add_custom_target(_waypoint_maker_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "waypoint_maker" "/home/foscar/ISCC_2022/src/lidar_team/waypoint_maker/msg/DynamicVelocity.msg" ""
)

get_filename_component(_filename "/home/foscar/ISCC_2022/src/lidar_team/waypoint_maker/msg/Boundingbox.msg" NAME_WE)
add_custom_target(_waypoint_maker_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "waypoint_maker" "/home/foscar/ISCC_2022/src/lidar_team/waypoint_maker/msg/Boundingbox.msg" ""
)

get_filename_component(_filename "/home/foscar/ISCC_2022/src/lidar_team/waypoint_maker/msg/ObjectInfo.msg" NAME_WE)
add_custom_target(_waypoint_maker_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "waypoint_maker" "/home/foscar/ISCC_2022/src/lidar_team/waypoint_maker/msg/ObjectInfo.msg" ""
)

get_filename_component(_filename "/home/foscar/ISCC_2022/src/lidar_team/waypoint_maker/msg/Waypoint.msg" NAME_WE)
add_custom_target(_waypoint_maker_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "waypoint_maker" "/home/foscar/ISCC_2022/src/lidar_team/waypoint_maker/msg/Waypoint.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/waypoint_maker)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/waypoint_maker\")")
  # install generated code
  install(
