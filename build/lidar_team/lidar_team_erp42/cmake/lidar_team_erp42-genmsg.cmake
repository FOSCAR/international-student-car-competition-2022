...
message(STATUS "lidar_team_erp42: 6 messages, 0 services")
...
get_filename_component(_filename "/home/foscar/ISCC_2022/src/lidar_team/lidar_team_erp42/msg/PurePursuit.msg" NAME_WE)
add_custom_target(_lidar_team_erp42_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lidar_team_erp42" "/home/foscar/ISCC_2022/src/lidar_team/lidar_team_erp42/msg/PurePursuit.msg" ""
)
...
_generate_msg_cpp(lidar_team_erp42
  "/home/foscar/ISCC_2022/src/lidar_team/lidar_team_erp42/msg/PurePursuit.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/lidar_team_erp42
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lidar_team_erp42)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lidar_team_erp42\")")
  # install generated code
  install(
