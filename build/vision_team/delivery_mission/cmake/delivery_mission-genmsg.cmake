...
set(MSG_I_FLAGS "-Idelivery_mission:/home/foscar/ISCC_2022/src/vision_team/delivery_mission/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/foscar/ISCC_2022/src/vision_team/delivery_mission/msg/drive_values.msg" NAME_WE)
add_custom_target(_delivery_mission_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "delivery_mission" "/home/foscar/ISCC_2022/src/vision_team/delivery_mission/msg/drive_values.msg" ""
)
...
_generate_msg_cpp(delivery_mission
  "/home/foscar/ISCC_2022/src/vision_team/delivery_mission/msg/drive_values.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/delivery_mission)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/delivery_mission\")")
  # install generated code
  install(
