...
"""autogenerated by genpy from obstacles_detector/WaypointList.msg. Do not edit."""
import codecs
import sys
...
import obstacles_detector.msg
import std_msgs.msg

class WaypointList(genpy.Message):
  _md5sum = "a4ae0fee55df3baa0344e6959a295b8c"
  _type = "obstacles_detector/WaypointList"
...
float64 y"""
  ...
  _slot_types = ['std_msgs/Header','obstacles_detector/Waypoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = obstacles_detector.msg.Waypoint()
        _v3 = val1.header
        start = end
        end += 4
