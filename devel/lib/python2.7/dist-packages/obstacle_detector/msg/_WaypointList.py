...
"""autogenerated by genpy from obstacle_detector/WaypointList.msg. Do not edit."""
import codecs
import sys
...
class WaypointList(genpy.Message):
  ...
  _type = "obstacle_detector/WaypointList"
...
float64 y"""
  ...
  _slot_types = ['std_msgs/Header','obstacle_detector/Waypoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = obstacle_detector.msg.Waypoint()
        _v3 = val1.header
        start = end
        end += 4
