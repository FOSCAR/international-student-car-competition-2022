...
if("TRUE" STREQUAL "TRUE")
  set(track_race_SOURCE_PREFIX /home/foscar/ISCC_2022/src/lidar_team/track_race)
  set(track_race_DEVEL_PREFIX /home/foscar/ISCC_2022/devel)
  ...
  set(track_race_INSTALL_PREFIX /home/foscar/ISCC_2022/install)
...
if(NOT "/home/foscar/ISCC_2022/devel/include;/home/foscar/ISCC_2022/src/lidar_team/track_race/include " STREQUAL " ")
  set(track_race_INCLUDE_DIRS "")
  set(_include_dirs "/home/foscar/ISCC_2022/devel/include;/home/foscar/ISCC_2022/src/lidar_team/track_race/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'track_race' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/foscar/ISCC_2022/src/lidar_team/track_race/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND track_race_EXPORTED_TARGETS ${${track_race_dep}_EXPORTED_TARGETS})
endforeach()
