...
(cl:defmethod cl:initialize-instance :after ((m <PurePursuit>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PurePursuit)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_team_morai-msg:<PurePursuit> is deprecated: use lidar_team_morai-msg:PurePursuit instead.")))
