...
(cl:defmethod cl:initialize-instance :after ((m <Boundingbox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Boundingbox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obstacles_detector-msg:<Boundingbox> is deprecated: use obstacles_detector-msg:Boundingbox instead.")))
...
(cl:defmethod z-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacles_detector-msg:z-val is deprecated.  Use obstacles_detector-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'volume-val :lambda-list '(m))
(cl:defmethod volume-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacles_detector-msg:volume-val is deprecated.  Use obstacles_detector-msg:volume instead.")
  (volume m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacles_detector-msg:distance-val is deprecated.  Use obstacles_detector-msg:distance instead.")
  (distance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Boundingbox>)))
  ...
  "obstacles_detector/Boundingbox")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Boundingbox)))
  "Returns string type for a message object of type 'Boundingbox"
  "obstacles_detector/Boundingbox")
