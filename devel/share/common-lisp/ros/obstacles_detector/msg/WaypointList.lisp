...
(cl:defclass <WaypointList> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (list
    :reader list
    :initarg :list
    :type (cl:vector obstacles_detector-msg:Waypoint)
   :initform (cl:make-array 0 :element-type 'obstacles_detector-msg:Waypoint :initial-element (cl:make-instance 'obstacles_detector-msg:Waypoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <WaypointList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obstacles_detector-msg:<WaypointList> is deprecated: use obstacles_detector-msg:WaypointList instead.")))
...
(cl:defmethod list-val ((m <WaypointList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacles_detector-msg:list-val is deprecated.  Use obstacles_detector-msg:list instead.")
  (list m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <WaypointList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'list)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'obstacles_detector-msg:Waypoint))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WaypointList>)))
  ...
  "obstacles_detector/WaypointList")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WaypointList)))
  "Returns string type for a message object of type 'WaypointList"
  "obstacles_detector/WaypointList")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<WaypointList>)))
  ...
  "a4ae0fee55df3baa0344e6959a295b8c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'WaypointList)))
  "Returns md5sum for a message object of type 'WaypointList"
  "a4ae0fee55df3baa0344e6959a295b8c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WaypointList>)))
  ...
  (cl:format cl:nil "Header header~%~%Waypoint[] list ~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: obstacles_detector/Waypoint~%Header header~%~%float64 x~%float64 y~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WaypointList)))
  "Returns full string definition for message of type 'WaypointList"
  (cl:format cl:nil "Header header~%~%Waypoint[] list ~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: obstacles_detector/Waypoint~%Header header~%~%float64 x~%float64 y~%~%"))
