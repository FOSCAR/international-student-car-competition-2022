...
(cl:defmethod cl:initialize-instance :after ((m <ObjectInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_team_beta-msg:<ObjectInfo> is deprecated: use lidar_team_beta-msg:ObjectInfo instead.")))

(cl:ensure-generic-function 'total-val :lambda-list '(m))
(cl:defmethod total-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_beta-msg:total-val is deprecated.  Use lidar_team_beta-msg:total instead.")
  (total m))
...
(cl:defmethod r-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_beta-msg:r-val is deprecated.  Use lidar_team_beta-msg:r instead.")
  (r m))
