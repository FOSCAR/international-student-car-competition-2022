...
(cl:defmethod cl:initialize-instance :after ((m <DynamicVelocity>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DynamicVelocity)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_team_beta-msg:<DynamicVelocity> is deprecated: use lidar_team_beta-msg:DynamicVelocity instead.")))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <DynamicVelocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_beta-msg:throttle-val is deprecated.  Use lidar_team_beta-msg:throttle instead.")
  (throttle m))

(cl:ensure-generic-function 'steering-val :lambda-list '(m))
(cl:defmethod steering-val ((m <DynamicVelocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_beta-msg:steering-val is deprecated.  Use lidar_team_beta-msg:steering instead.")
  (steering m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DynamicVelocity>)))
  ...
  "lidar_team_beta/DynamicVelocity")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DynamicVelocity)))
  "Returns string type for a message object of type 'DynamicVelocity"
  "lidar_team_beta/DynamicVelocity")
