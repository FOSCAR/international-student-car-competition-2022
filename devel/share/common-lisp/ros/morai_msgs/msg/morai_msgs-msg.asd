...
(defsystem "morai_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "SyncModeAddObj" :depends-on ("_package_SyncModeAddObj"))
    (:file "_package_SyncModeAddObj" :depends-on ("_package"))
    ...
    (:file "SyncModeRemoveObj" :depends-on ("_package_SyncModeRemoveObj"))
    (:file "_package_SyncModeRemoveObj" :depends-on ("_package"))
