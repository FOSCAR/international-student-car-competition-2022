...
(cl:defclass <WaypointList> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (info
    :reader info
    :initarg :info
    :type (cl:vector lidar_team_erp42-msg:Waypoint)
   :initform (cl:make-array 0 :element-type 'lidar_team_erp42-msg:Waypoint :initial-element (cl:make-instance 'lidar_team_erp42-msg:Waypoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <WaypointList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_team_erp42-msg:<WaypointList> is deprecated: use lidar_team_erp42-msg:WaypointList instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <WaypointList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_erp42-msg:header-val is deprecated.  Use lidar_team_erp42-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'info-val :lambda-list '(m))
(cl:defmethod info-val ((m <WaypointList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_erp42-msg:info-val is deprecated.  Use lidar_team_erp42-msg:info instead.")
  (info m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <WaypointList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'info)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'lidar_team_erp42-msg:Waypoint))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<WaypointList>)))
  ...
  "5103fdd73a1575a4d565f16f08c82984")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'WaypointList)))
  "Returns md5sum for a message object of type 'WaypointList"
  "5103fdd73a1575a4d565f16f08c82984")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WaypointList>)))
  ...
  (cl:format cl:nil "Header header~%~%Waypoint[] info~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: lidar_team_erp42/Waypoint~%int32 cnt~%float32[200] x_arr~%float32[200] y_arr~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WaypointList)))
  "Returns full string definition for message of type 'WaypointList"
  (cl:format cl:nil "Header header~%~%Waypoint[] info~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: lidar_team_erp42/Waypoint~%int32 cnt~%float32[200] x_arr~%float32[200] y_arr~%~%"))
