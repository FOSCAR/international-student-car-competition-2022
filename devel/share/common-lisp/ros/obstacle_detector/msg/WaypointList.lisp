...
(cl:defclass <WaypointList> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (list
    :reader list
    :initarg :list
    :type (cl:vector obstacle_detector-msg:Waypoint)
   :initform (cl:make-array 0 :element-type 'obstacle_detector-msg:Waypoint :initial-element (cl:make-instance 'obstacle_detector-msg:Waypoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <WaypointList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obstacle_detector-msg:<WaypointList> is deprecated: use obstacle_detector-msg:WaypointList instead.")))
...
(cl:defmethod list-val ((m <WaypointList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detector-msg:list-val is deprecated.  Use obstacle_detector-msg:list instead.")
  (list m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <WaypointList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'list)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'obstacle_detector-msg:Waypoint))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WaypointList>)))
  ...
  "obstacle_detector/WaypointList")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WaypointList)))
  "Returns string type for a message object of type 'WaypointList"
  "obstacle_detector/WaypointList")
