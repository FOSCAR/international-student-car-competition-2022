...
struct DeliveryArray_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::vision_distance::Delivery_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::vision_distance::Delivery_<ContainerAllocator> >::other >  _visions_type;
