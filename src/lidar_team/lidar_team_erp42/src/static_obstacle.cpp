...
void dynamicParamCallback(lidar_team_erp42::st_hyper_parameterConfig &config, int32_t level) {
...
int main(int argc, char **argv) {
  ...
  dynamic_reconfigure::Server<lidar_team_erp42::st_hyper_parameterConfig> server;
  dynamic_reconfigure::Server<lidar_team_erp42::st_hyper_parameterConfig>::CallbackType f;
