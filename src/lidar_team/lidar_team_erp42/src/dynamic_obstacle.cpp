...
void dynamicParamCallback(lidar_team_erp42::dy_hyper_parameterConfig &config, int32_t level) {
...
int main(int argc, char **argv) {
  ...
  dynamic_reconfigure::Server<lidar_team_erp42::dy_hyper_parameterConfig> server;
  dynamic_reconfigure::Server<lidar_team_erp42::dy_hyper_parameterConfig>::CallbackType f;
  ...
  dynamicObsPosePub = nh.advertise<lidar_team_erp42::Boundingbox>("/dynamic_obs_position", 0.001);    
