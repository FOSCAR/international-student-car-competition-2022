      ...
      if ( (obstacle_left_vec.size() == 1) || (obstacle_right_vec.size() == 1) || (abs(left_size - right_size) >= 3) ) {
        ...
        if ( obstacle_left_vec.size() < obstacle_right_vec.size() ) {
          ...
          for (int i = 0; i < obstacle_right_vec.size(); i++) {
            ...
            waypoint.emplace_back( (obstacle_right_vec[i][0]) - (obstacle_right_vec[0][0] * 2 / 3));
            waypoint.emplace_back( (obstacle_right_vec[i][1]) - (obstacle_right_vec[0][1] * 2 / 3));
          ...
          for (int i = 0; i < obstacle_left_vec.size(); i++) {
            vector<float> waypoint;
            waypoint.emplace_back( (obstacle_left_vec[i][0]) - (obstacle_left_vec[0][0] * 2 / 3));
            waypoint.emplace_back( (obstacle_left_vec[i][1]) - (obstacle_left_vec[0][1] * 2 / 3));
